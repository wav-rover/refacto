...
module.exports = {
  forbidden: [
    {
      name: "no-db-or-infra-in-domain",
      severity: "error",
      comment:
        "Le domaine ne doit pas importer de modules d'infrastructure (DB, HTTP). " +
        "Les modules sous src/domain doivent rester purs et ne pas dépendre de mysql2, sqlite3, express, etc.",
...
// generated: dependency-cruiser@17.3.8 on 2026-02-20T23:13:58.592Z
