(() => {
  ...
  function App() {
    ...
    return /* @__PURE__ */ import_react.default.createElement(Container, null, /* @__PURE__ */ import_react.default.createElement(Row, null, /* @__PURE__ */ import_react.default.createElement(Col, { md: { offset: 3, span: 6 } }, /* @__PURE__ */ import_react.default.createElement(TodoListCard, null))));
  }
  function TodoListCard() {
    const [items, setItems] = import_react.default.useState(null);
    import_react.default.useEffect(() => {
      fetch("/items").then(
        (r) => r.ok ? r.json() : Promise.reject(new Error(String(r.status)))
      ).then((data) => setItems(data)).catch(() => setItems([]));
    }, []);
    const onNewItem = import_react.default.useCallback((newItem) => {
      setItems((prev) => prev ? [...prev, newItem] : [newItem]);
    }, []);
    const onItemUpdate = import_react.default.useCallback((item) => {
      setItems((prev) => {
        if (!prev) return prev;
    ...
    const onItemRemoval = import_react.default.useCallback((item) => {
      setItems((prev) => {
        if (!prev) return prev;
        const index = prev.findIndex((i) => i.id === item.id);
    ...
    return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement(AddItemForm, { onNewItem }), items.length === 0 && /* @__PURE__ */ import_react.default.createElement("p", { className: "text-center" }, "No items yet! Add one above!"), items.map((item) => /* @__PURE__ */ import_react.default.createElement(
      ItemDisplay,
      {
        item,
        key: item.id,
  ...
  function AddItemForm({ onNewItem }) {
    ...
    ), /* @__PURE__ */ import_react.default.createElement(InputGroup.Append, null, /* @__PURE__ */ import_react.default.createElement(
      Button,
      {
        type: "submit",
        variant: "success",
  ...
  if (root) {
    ReactDOM.render(/* @__PURE__ */ import_react.default.createElement(App, null), root);
  }
})();
