...
- **Contrat par route :** quand une route a des tests verts, noter brièvement statut HTTP, structure JSON et cas d’erreur. → [contrats-routes.md](../../architecture/contrats-routes.md)
